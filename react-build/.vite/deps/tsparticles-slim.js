import { A as isSsr, B as getRandom, C as getLogger, D as isInArray, E as isDivModeEnabled, F as addEasing, G as setRangeValue, H as getRangeValue, I as clamp, K as Vector, L as getDistance, M as itemFromSingleOrMultiple, N as loadFont, O as isObject, P as rectBounce, R as getDistances, S as executeOnSingleOrMultiple, T as isArray, U as getValue, V as getRangeMax, W as randomInRange, Y as mouseMoveEvent, _ as calculateBounds, a as OptionsColor, b as divMode, c as colorMix, d as getLinkRandomColor, f as getStyleFromHsl, g as rgbToHsl, h as rangeColorToRgb, i as ValueWithRandom, j as itemFromArray, k as isPointInside, l as getHslAnimationFromHsl, m as rangeColorToHsl, n as Circle, o as drawLine, p as getStyleFromRgb, q as errorPrefix, r as Rectangle, s as drawTriangle, t as tsParticles, u as getLinkColor, v as circleBounce, w as initParticleNumericAnimationValue, x as divModeExecute, y as circleBounceDataFromParticle, z as getEasing } from "./esm-CZKWRZUG.js";
//#region node_modules/tsparticles-engine/esm/Core/Utils/ExternalInteractorBase.js
...
//#endregion
//#region node_modules/tsparticles-engine/esm/Core/Utils/ParticlesInteractorBase.js
...
//#endregion
//#region node_modules/tsparticles-particles.js/esm/marcbruederlin/Particles.js
var Particles = class Particles {
	static init(options) {
		...
		tsParticles.set(selector.replace(".", "").replace("!", ""), el, {
			...
			particles: {
				color: { value: options.color ?? "!000000" },
				links: {
					color: "random",
				...
				number: { value: options.maxParticles ?? 100 },
				size: { value: {
					min: 1,
			...
			responsive: options.responsive?.map((responsive) => ({
				...
				options: { particles: {
					color: { value: responsive.options?.color },
					links: {
						distance: responsive.options?.minDistance,
						enable: responsive.options?.connectParticles
					},
					number: { value: options.maxParticles },
					move: {
						enable: true,
						speed: responsive.options?.speed
					},
					size: { value: responsive.options?.sizeVariations }
				} }
			}))
		}).then((container) => {
...
//#endregion
//#region node_modules/tsparticles-particles.js/esm/VincentGarreau/particles.js
...
//#endregion
//#region node_modules/tsparticles-particles.js/esm/index.js
var initPjs = (engine) => {
...
//#endregion
//#region node_modules/tsparticles-move-base/esm/Utils.js
...
//#endregion
//#region node_modules/tsparticles-move-base/esm/BaseMover.js
var diffFactor = 2;
var BaseMover = class {
	constructor() {
...
//#endregion
//#region node_modules/tsparticles-shape-circle/esm/index.js
async function loadCircleShape(engine, refresh = true) {
	await engine.addShape("circle", new CircleDrawer(), refresh);
}
//#endregion
//#region node_modules/tsparticles-updater-color/esm/Utils.js
...
function updateColor(particle, delta) {
	...
	if (!color) return;
	const { h, s, l } = color;
	if (h) updateColorValue$1(delta, h, hAnimation, 360, false);
	if (s) updateColorValue$1(delta, s, sAnimation, 100, true);
	if (l) updateColorValue$1(delta, l, lAnimation, 100, true);
}
//#endregion
//#region node_modules/tsparticles-updater-color/esm/ColorUpdater.js
var ColorUpdater = class {
	...
	init(particle) {
		...
		if (hslColor) particle.color = getHslAnimationFromHsl(hslColor, particle.options.color.animation, this.container.retina.reduceFactor);
	}
	isEnabled(particle) {
		const { h: hAnimation, s: sAnimation, l: lAnimation } = particle.options.color.animation, { color } = particle;
...
//#endregion
//#region node_modules/tsparticles-updater-color/esm/index.js
async function loadColorUpdater(engine, refresh = true) {
	await engine.addParticleUpdater("color", (container) => new ColorUpdater(container), refresh);
}
//#endregion
//#region node_modules/tsparticles-updater-opacity/esm/Utils.js
...
//#endregion
//#region node_modules/tsparticles-updater-opacity/esm/OpacityUpdater.js
...
//#endregion
//#region node_modules/tsparticles-updater-opacity/esm/index.js
async function loadOpacityUpdater(engine, refresh = true) {
	await engine.addParticleUpdater("opacity", (container) => new OpacityUpdater(container), refresh);
}
//#endregion
//#region node_modules/tsparticles-updater-out-modes/esm/Utils.js
...
//#endregion
//#region node_modules/tsparticles-updater-out-modes/esm/BounceOutMode.js
...
//#endregion
//#region node_modules/tsparticles-updater-out-modes/esm/DestroyOutMode.js
...
//#endregion
//#region node_modules/tsparticles-updater-out-modes/esm/NoneOutMode.js
...
//#endregion
//#region node_modules/tsparticles-updater-out-modes/esm/OutOutMode.js
...
//#endregion
//#region node_modules/tsparticles-updater-out-modes/esm/OutOfCanvasUpdater.js
...
//#endregion
//#region node_modules/tsparticles-updater-out-modes/esm/index.js
async function loadOutModesUpdater(engine, refresh = true) {
	await engine.addParticleUpdater("outModes", (container) => new OutOfCanvasUpdater(container), refresh);
}
//#endregion
//#region node_modules/tsparticles-updater-size/esm/Utils.js
...
function updateSize(particle, delta) {
	...
	switch (data.status) {
		case "increasing":
			...
			break;
		case "decreasing": if (data.value <= minValue) {
			data.status = "increasing";
			if (!data.loops) data.loops = 0;
			data.loops++;
		} else data.value -= sizeVelocity;
...
//#endregion
//#region node_modules/tsparticles-updater-size/esm/SizeUpdater.js
...
//#endregion
//#region node_modules/tsparticles-updater-size/esm/index.js
async function loadSizeUpdater(engine, refresh = true) {
	await engine.addParticleUpdater("size", () => new SizeUpdater(), refresh);
}
//#endregion
//#region node_modules/tsparticles-basic/esm/index.js
...
//#endregion
//#region node_modules/tsparticles-plugin-easing-quad/esm/index.js
async function loadEasingQuadPlugin() {
	addEasing("ease-in-quad", (value) => value ** 2);
	addEasing("ease-out-quad", (value) => 1 - (1 - value) ** 2);
	addEasing("ease-in-out-quad", (value) => value < .5 ? 2 * value ** 2 : 1 - (-2 * value + 2) ** 2 / 2);
}
//#endregion
//#region node_modules/tsparticles-interaction-external-attract/esm/Options/Classes/Attract.js
var Attract = class {
	constructor() {
		this.distance = 200;
		this.duration = .4;
...
//#endregion
//#region node_modules/tsparticles-interaction-external-attract/esm/Attractor.js
var Attractor$1 = class extends ExternalInteractorBase {
	constructor(engine, container) {
		...
		this.handleClickMode = (mode) => {
			...
			if (!attract || mode !== "attract") return;
			if (!container.attract) container.attract = { particles: [] };
	...
	async interact() {
		...
		if (mouseMoveStatus && hoverEnabled && isInArray("attract", hoverMode)) this._hoverAttract();
		else if (clickEnabled && isInArray("attract", clickMode)) this._clickAttract();
	}
	isEnabled(particle) {
...
//#endregion
//#region node_modules/tsparticles-interaction-external-attract/esm/index.js
...
//#endregion
//#region node_modules/tsparticles-interaction-external-bounce/esm/Options/Classes/Bounce.js
var Bounce = class {
	constructor() {
		this.distance = 200;
	}
...
//#endregion
//#region node_modules/tsparticles-interaction-external-bounce/esm/Bouncer.js
var Bouncer = class extends ExternalInteractorBase {
	constructor(container) {
		...
		this._processMouseBounce = () => {
			const container = this.container, tolerance = 10 * container.retina.pixelRatio, mousePos = container.interactivity.mouse.position, radius = container.retina.bounceModeDistance;
	...
	async interact() {
		...
		if (mouseMoveStatus && hoverEnabled && isInArray("bounce", hoverMode)) this._processMouseBounce();
		else divModeExecute("bounce", divs, (selector, div) => this._singleSelectorBounce(selector, div));
	}
	isEnabled(particle) {
...
//#endregion
//#region node_modules/tsparticles-interaction-external-bounce/esm/index.js
async function loadExternalBounceInteraction(engine, refresh = true) {
	await engine.addInteractor("externalBounce", (container) => new Bouncer(container), refresh);
}
//#endregion
//#region node_modules/tsparticles-interaction-external-bubble/esm/Options/Classes/BubbleBase.js
...
//#endregion
//#region node_modules/tsparticles-interaction-external-bubble/esm/Options/Classes/BubbleDiv.js
var BubbleDiv = class extends BubbleBase {
	...
	load(data) {
		super.load(data);
		if (!data) return;
		if (data.ids !== void 0) this.ids = data.ids;
		if (data.selectors !== void 0) this.selectors = data.selectors;
	}
};
//#endregion
//#region node_modules/tsparticles-interaction-external-bubble/esm/Options/Classes/Bubble.js
...
//#endregion
//#region node_modules/tsparticles-interaction-external-bubble/esm/Utils.js
...
//#endregion
//#region node_modules/tsparticles-interaction-external-bubble/esm/Bubbler.js
var Bubbler = class extends ExternalInteractorBase {
	constructor(container) {
		...
		this._clickBubble = () => {
			...
			for (const particle of query) {
				...
				const distMouse = getDistance(particle.getPosition(), mouseClickPos), timeSpent = ((/* @__PURE__ */ new Date()).getTime() - (container.interactivity.mouse.clickTime || 0)) / 1e3;
		...
		this._hoverBubble = () => {
			...
			if (!distance || distance < 0 || mousePos === void 0) return;
			const query = container.particles.quadTree.queryCircle(mousePos, distance, (p) => this.isEnabled(p));
			for (const particle of query) {
				particle.bubble.inRange = true;
				const pointDistance = getDistance(particle.getPosition(), mousePos), ratio = 1 - pointDistance / distance;
				if (pointDistance <= distance) {
					if (ratio >= 0 && container.interactivity.status === "pointermove") {
		...
		this._hoverBubbleOpacity = (particle, ratio, divBubble) => {
			...
			const optOpacity = particle.options.opacity.value, opacity = calculateBubbleValue(particle.opacity?.value ?? 1, modeOpacity, getRangeMax(optOpacity), ratio);
	...
	async interact(delta) {
		...
		if (hoverEnabled && isInArray("bubble", hoverMode)) this._hoverBubble();
		else if (clickEnabled && isInArray("bubble", clickMode)) this._clickBubble();
		else divModeExecute("bubble", divs, (selector, div) => this._singleSelectorHover(delta, selector, div));
	}
	isEnabled(particle) {
		const container = this.container, options = container.actualOptions, mouse = container.interactivity.mouse, { onClick, onDiv, onHover } = (particle?.interactivity ?? options.interactivity).events, divBubble = isDivModeEnabled("bubble", onDiv);
...
//#endregion
//#region node_modules/tsparticles-interaction-external-bubble/esm/index.js
async function loadExternalBubbleInteraction(engine, refresh = true) {
	await engine.addInteractor("externalBubble", (container) => new Bubbler(container), refresh);
}
//#endregion
//#region node_modules/tsparticles-interaction-external-connect/esm/Options/Classes/ConnectLinks.js
...
//#endregion
//#region node_modules/tsparticles-interaction-external-connect/esm/Options/Classes/Connect.js
var Connect = class {
	constructor() {
		this.distance = 80;
...
//#endregion
//#region node_modules/tsparticles-interaction-external-connect/esm/Utils.js
...
//#endregion
//#region node_modules/tsparticles-interaction-external-connect/esm/Connector.js
...
//#endregion
//#region node_modules/tsparticles-interaction-external-connect/esm/index.js
...
//#endregion
//#region node_modules/tsparticles-interaction-external-grab/esm/Options/Classes/GrabLinks.js
var GrabLinks = class {
	constructor() {
		this.blink = false;
		this.consent = false;
...
//#endregion
//#region node_modules/tsparticles-interaction-external-grab/esm/Options/Classes/Grab.js
var Grab = class {
	constructor() {
		this.distance = 100;
...
//#endregion
//#region node_modules/tsparticles-interaction-external-grab/esm/Utils.js
...
//#endregion
//#region node_modules/tsparticles-interaction-external-grab/esm/Grabber.js
...
//#endregion
//#region node_modules/tsparticles-interaction-external-grab/esm/index.js
...
//#endregion
//#region node_modules/tsparticles-interaction-external-pause/esm/Pauser.js
...
//#endregion
//#region node_modules/tsparticles-interaction-external-pause/esm/index.js
...
//#endregion
//#region node_modules/tsparticles-interaction-external-push/esm/Options/Classes/Push.js
var Push = class {
	constructor() {
		this.default = true;
		this.groups = [];
...
//#endregion
//#region node_modules/tsparticles-interaction-external-push/esm/Pusher.js
var Pusher = class extends ExternalInteractorBase {
	constructor(container) {
		...
		this.handleClickMode = (mode) => {
			...
			const group = itemFromArray([void 0, ...pushOptions.groups]), groupOptions = group !== void 0 ? container.actualOptions.particles.groups[group] : void 0;
...
//#endregion
//#region node_modules/tsparticles-interaction-external-push/esm/index.js
...
//#endregion
//#region node_modules/tsparticles-interaction-external-remove/esm/Options/Classes/Remove.js
var Remove = class {
	constructor() {
		this.quantity = 2;
	}
...
//#endregion
//#region node_modules/tsparticles-interaction-external-remove/esm/Remover.js
var Remover = class extends ExternalInteractorBase {
	constructor(container) {
		super(container);
		this.handleClickMode = (mode) => {
			const container = this.container, options = container.actualOptions;
			if (!options.interactivity.modes.remove || mode !== "remove") return;
...
//#endregion
//#region node_modules/tsparticles-interaction-external-remove/esm/index.js
...
//#endregion
//#region node_modules/tsparticles-interaction-external-repulse/esm/Options/Classes/RepulseBase.js
...
//#endregion
//#region node_modules/tsparticles-interaction-external-repulse/esm/Options/Classes/RepulseDiv.js
...
//#endregion
//#region node_modules/tsparticles-interaction-external-repulse/esm/Options/Classes/Repulse.js
...
//#endregion
//#region node_modules/tsparticles-interaction-external-repulse/esm/Repulser.js
var Repulser = class extends ExternalInteractorBase {
	constructor(engine, container) {
		...
		this.handleClickMode = (mode) => {
			...
			if (!repulseOpts || mode !== "repulse") return;
			if (!container.repulse) container.repulse = { particles: [] };
	...
	async interact() {
		...
		if (mouseMoveStatus && hoverEnabled && isInArray("repulse", hoverMode)) this._hoverRepulse();
		else if (clickEnabled && isInArray("repulse", clickMode)) this._clickRepulse();
		else divModeExecute("repulse", divs, (selector, div) => this._singleSelectorRepulse(selector, div));
	}
	isEnabled(particle) {
...
//#endregion
//#region node_modules/tsparticles-interaction-external-repulse/esm/index.js
...
//#endregion
//#region node_modules/tsparticles-interaction-external-slow/esm/Options/Classes/Slow.js
var Slow = class {
	constructor() {
		this.factor = 3;
		this.radius = 200;
...
//#endregion
//#region node_modules/tsparticles-interaction-external-slow/esm/Slower.js
...
//#endregion
//#region node_modules/tsparticles-interaction-external-slow/esm/index.js
...
//#endregion
//#region node_modules/tsparticles-shape-image/esm/GifUtils/Constants.js
...
//#endregion
//#region node_modules/tsparticles-shape-image/esm/GifUtils/ByteStream.js
var ByteStream = class {
	...
	readSubBlocksBin() {
		...
		for (let i = 0; (size = this.data[this.pos++]) !== 0;) for (let count = size; --count >= 0; blockData[i++] = this.data[this.pos++]);
		return blockData;
	}
	skipSubBlocks() {
...
//#endregion
//#region node_modules/tsparticles-shape-image/esm/GifUtils/Utils.js
...
async function parseImageBlock(byteStream, gif, avgAlpha, getFrameIndex, getTransparencyIndex, progressCallback) {
	...
	if (interlacedFlag) {
		for (let code = 0, size = minCodeSize + 1, pos = 0, dic = [[0]], pass = 0; pass < 4; pass++) {
			if (InterlaceOffsets[pass] < frame.height) for (let pixelPos = 0, lineIndex = 0;;) {
				const last = code;
...
//#endregion
//#region node_modules/tsparticles-shape-image/esm/Utils.js
...
//#endregion
//#region node_modules/tsparticles-shape-image/esm/ImageDrawer.js
var ImageDrawer = class {
	...
	draw(context, particle, radius, opacity, delta) {
		...
		if (image.gif && image.gifData) {
			...
			if (particle.gifLoopCount === void 0) particle.gifLoopCount = image.gifLoopCount ?? 0;
			let frameIndex = particle.gifFrame ?? 0;
			const pos = {
				x: -image.gifData.width * .5,
				y: -image.gifData.height * .5
			}, frame = image.gifData.frames[frameIndex];
			if (particle.gifTime === void 0) particle.gifTime = 0;
...
//#endregion
//#region node_modules/tsparticles-shape-image/esm/Options/Classes/Preload.js
var Preload = class {
	constructor() {
		this.src = "";
		this.gif = false;
...
//#endregion
//#region node_modules/tsparticles-shape-image/esm/ImagePreloader.js
...
//#endregion
//#region node_modules/tsparticles-shape-image/esm/index.js
function addLoadImageToEngine(engine) {
	...
	engine.loadImage = async (data) => {
		...
		try {
			...
			await (data.gif ? loadGifImage : data.replaceColor ? downloadSvgImage : loadImage)(image);
		} catch {
...
//#endregion
//#region node_modules/tsparticles-updater-life/esm/Options/Classes/LifeDelay.js
...
//#endregion
//#region node_modules/tsparticles-updater-life/esm/Options/Classes/LifeDuration.js
...
//#endregion
//#region node_modules/tsparticles-updater-life/esm/Options/Classes/Life.js
var Life = class {
	constructor() {
		this.count = 0;
...
//#endregion
//#region node_modules/tsparticles-updater-life/esm/LifeUpdater.js
...
//#endregion
//#region node_modules/tsparticles-updater-life/esm/index.js
async function loadLifeUpdater(engine, refresh = true) {
	await engine.addParticleUpdater("life", (container) => new LifeUpdater(container), refresh);
}
//#endregion
//#region node_modules/tsparticles-shape-line/esm/LineDrawer.js
...
//#endregion
//#region node_modules/tsparticles-shape-line/esm/index.js
async function loadLineShape(engine, refresh = true) {
	await engine.addShape("line", new LineDrawer(), refresh);
}
//#endregion
//#region node_modules/tsparticles-move-parallax/esm/ParallaxMover.js
...
//#endregion
//#region node_modules/tsparticles-move-parallax/esm/index.js
async function loadParallaxMover(engine, refresh = true) {
	await engine.addMover("parallax", () => new ParallaxMover(), refresh);
}
//#endregion
//#region node_modules/tsparticles-interaction-particles-attract/esm/Attractor.js
var Attractor = class extends ParticlesInteractorBase {
	...
	async interact(p1) {
		...
		for (const p2 of query) {
			...
			const { dx, dy } = getDistances(pos1, p2.getPosition()), rotate = p1.options.move.attract.rotate, ax = dx / (rotate.x * 1e3), ay = dy / (rotate.y * 1e3), p1Factor = p2.size.value / p1.size.value, p2Factor = 1 / p1Factor;
...
//#endregion
//#region node_modules/tsparticles-interaction-particles-attract/esm/index.js
...
//#endregion
//#region node_modules/tsparticles-interaction-particles-collisions/esm/Absorb.js
...
//#endregion
//#region node_modules/tsparticles-interaction-particles-collisions/esm/Bounce.js
...
//#endregion
//#region node_modules/tsparticles-interaction-particles-collisions/esm/Destroy.js
...
//#endregion
//#region node_modules/tsparticles-interaction-particles-collisions/esm/ResolveCollision.js
...
//#endregion
//#region node_modules/tsparticles-interaction-particles-collisions/esm/Collider.js
...
//#endregion
//#region node_modules/tsparticles-interaction-particles-collisions/esm/index.js
...
//#endregion
//#region node_modules/tsparticles-interaction-particles-links/esm/CircleWarp.js
...
//#endregion
//#region node_modules/tsparticles-interaction-particles-links/esm/Options/Classes/LinksShadow.js
...
//#endregion
//#region node_modules/tsparticles-interaction-particles-links/esm/Options/Classes/LinksTriangle.js
...
//#endregion
//#region node_modules/tsparticles-interaction-particles-links/esm/Options/Classes/Links.js
var Links = class {
	constructor() {
		this.blink = false;
		this.color = new OptionsColor();
...
//#endregion
//#region node_modules/tsparticles-interaction-particles-links/esm/Linker.js
...
var Linker = class extends ParticlesInteractorBase {
	...
	loadParticlesOptions(options, ...sources) {
		...
		for (const source of sources) options.links.load(source?.links ?? source?.lineLinked ?? source?.line_linked);
	}
	reset() {}
};
//#endregion
//#region node_modules/tsparticles-interaction-particles-links/esm/interaction.js
async function loadLinksInteraction(engine, refresh = true) {
	await engine.addInteractor("particlesLinks", (container) => new Linker(container), refresh);
}
//#endregion
//#region node_modules/tsparticles-interaction-particles-links/esm/Utils.js
...
//#endregion
//#region node_modules/tsparticles-interaction-particles-links/esm/LinkInstance.js
	...
	constructor(container) {
		...
		this._drawLinkLine = (p1, link) => {
			...
			container.canvas.draw((ctx) => {
				...
				if (twinkle?.enable) {
					const twinkleFreq = twinkle.frequency, twinkleRgb = rangeColorToRgb(twinkle.color);
...
//#endregion
//#region node_modules/tsparticles-interaction-particles-links/esm/plugin.js
...
//#endregion
//#region node_modules/tsparticles-interaction-particles-links/esm/index.js
async function loadParticlesLinksInteraction(engine, refresh = true) {
	await loadLinksInteraction(engine, refresh);
	await loadLinksPlugin(engine, refresh);
}
//#endregion
//#region node_modules/tsparticles-shape-polygon/esm/PolygonDrawerBase.js
...
//#endregion
//#region node_modules/tsparticles-shape-polygon/esm/PolygonDrawer.js
...
//#endregion
//#region node_modules/tsparticles-shape-polygon/esm/TriangleDrawer.js
...
//#endregion
//#region node_modules/tsparticles-shape-polygon/esm/index.js
...
//#endregion
//#region node_modules/tsparticles-updater-rotate/esm/Options/Classes/RotateAnimation.js
...
//#endregion
//#region node_modules/tsparticles-updater-rotate/esm/Options/Classes/Rotate.js
...
//#endregion
//#region node_modules/tsparticles-updater-rotate/esm/RotateUpdater.js
...
var RotateUpdater = class {
	...
	init(particle) {
		...
		if (rotateDirection === "random") rotateDirection = Math.floor(getRandom() * 2) > 0 ? "counter-clockwise" : "clockwise";
...
//#endregion
//#region node_modules/tsparticles-updater-rotate/esm/index.js
async function loadRotateUpdater(engine, refresh = true) {
	await engine.addParticleUpdater("rotate", (container) => new RotateUpdater(container), refresh);
}
//#endregion
//#region node_modules/tsparticles-shape-square/esm/SquareDrawer.js
...
//#endregion
//#region node_modules/tsparticles-shape-square/esm/index.js
async function loadSquareShape(engine, refresh = true) {
	await engine.addShape(["edge", "square"], new SquareDrawer(), refresh);
}
//#endregion
//#region node_modules/tsparticles-shape-star/esm/StarDrawer.js
...
//#endregion
//#region node_modules/tsparticles-shape-star/esm/index.js
async function loadStarShape(engine, refresh = true) {
	await engine.addShape("star", new StarDrawer(), refresh);
}
//#endregion
//#region node_modules/tsparticles-updater-stroke-color/esm/Utils.js
...
//#endregion
//#region node_modules/tsparticles-updater-stroke-color/esm/StrokeColorUpdater.js
...
//#endregion
//#region node_modules/tsparticles-updater-stroke-color/esm/index.js
async function loadStrokeColorUpdater(engine, refresh = true) {
	await engine.addParticleUpdater("strokeColor", (container) => new StrokeColorUpdater(container), refresh);
}
//#endregion
//#region node_modules/tsparticles-shape-text/esm/TextDrawer.js
var validTypes = [
	"text",
	"character",
	"char"
...
//#endregion
//#region node_modules/tsparticles-shape-text/esm/index.js
async function loadTextShape(engine, refresh = true) {
	await engine.addShape(validTypes, new TextDrawer(), refresh);
}
//#endregion
//#region node_modules/tsparticles-slim/esm/index.js
